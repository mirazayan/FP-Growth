...
# 2. Tahapan Algoritma FP Growth

# 3. Eksperimen Alogaritma FP Growth
## 3.1 Library
...
```{r}
# S3 method for rules
plot(df2, method = NULL, measure = "support", shading = "lift", 
    interactive = NULL, engine = "default", data = NULL, control = NULL)
# S3 method for itemsets
plot(df2, method = NULL, measure = "support", shading = NA,
    interactive = NULL, engine = "default", data = NULL, control = NULL)
```

```{r eval=FALSE}
DTModel=J48("mineral water"~.,df2)
DTModel
```
